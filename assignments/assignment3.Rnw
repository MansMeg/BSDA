...
\subsection*{Inference for normal mean and deviation}
...
\subsection*{Inference for the difference between proportions}
...
\subsection*{Inference for the difference between normal means}
