...
\textbf{Reading instructions:} Chapter 2 and 3 in BDA3, see reading instructions. Use \href{(https://www.fharrell.com/post/bayes-freq-stmts/}{Frank Harrell's recommendations} on how to state results in Bayesian two group comparisons (and note that there is no point null hypothesis testing in this assignment).
