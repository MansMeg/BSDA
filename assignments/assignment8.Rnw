...
PSIS LOO-CV approximates standard leave out cross validation. To compare the two, implement standard leave one out cross validation for the separate model.
