...
\item Mini-project: do your own Bayesian analysis (2-3 students)\pause
\end{itemize}
...
\begin{itemize}
\item Every week: lectures/and assignments (approx. 4h)
\begin{itemize}
...
\item If everything is correct in an assignment, 1 VG point is awarded.\pause
