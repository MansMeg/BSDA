...
\item Applications: Law, sociology, political science, and medicine
\end{enumerate}
\end{enumerate}
...
\begin{enumerate}
\item Name
\item What is your expectation on this course? Why did you choose it?
\end{enumerate}
...
\item Mini-project: own Bayesian data analysis or paper replication track (1-3 students)\pause
\end{itemize}
...
\begin{itemize}
\item You may use LLMs like fellow students: to learn, ask for explanations, and get feedback.\pause
...
\item LLMs are not allowed at all for the oral exam question contribution.\pause
\item Assignment PDFs may contain hidden machine-readable integrity text. Do not copy or upload the full assignment text into an LLM.
\end{itemize}
\end{frame}
...
\begin{itemize}
\item \uured{New thing this year}: Joint supervision and work with researchers and students (PhD and masters)
...
\item LLMs may be used for learning, explanations, and feedback, but not to produce submitted solutions.
\end{enumerate}
...
\begin{itemize}
  ...
  \item Hidden integrity text and Large Language Model use.
