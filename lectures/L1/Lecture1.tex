...
\begin{frame}{Probability in Bayesian Reasoning}
  ...
  \item Uncertainty and knowledge are expressed as probability distributions, why? \pause
    ...
    \item Knowledge as coherence of bets (the Dutch book): \uured{rationality}
...
A bookmaker could then take both bets from you and be sure to profit, because you have made your odds \\ \uured{incoherent}.
    \item Accuracy arguments: incoherent credences can be systematically worse estimates of truth
    \item Conditionalization: update by zeroing possibilities ruled out by evidence and rescaling the rest
  \pause
...
% the theory of knowledge, especially with regard to its methods, validity, and scope, and the distinction between justified belief and opinion
  ...
  \begin{itemize}
    ...
    \pause
    \begin{itemize}
    \item Studies rational degrees of belief, or credences
    \item Two core norms:
      \begin{itemize}
      \item Probabilism: beliefs at one time should obey the rules of probability
      \item Conditionalization: beliefs should be updated by conditioning on new evidence
      \end{itemize}
