...
\begin{frame}
  ...
  \end{itemize}
  \begin{center}
  \only<3>{\includegraphics[width=9cm]{figs/sexratio_bayes_1.pdf}}
  \only<4>{\includegraphics[width=9cm]{figs/sexratio_bayes_2.pdf}}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \begin{center}
  \only<2>{\includegraphics[width=10cm]{figs/map-data.png}\\Satellite estimates and ground monitor locations}
...
\begin{frame}{Structural information \only<1-2>{in predicting future}\only<3>{-- Prophet by Facebook}}
    ...
    \only<1>{\hspace*{-2.5cm}\includegraphics[width=16cm]{figs/rstan_downloads_forecast.pdf}}
    \only<2>{\hspace*{-2.5cm}\includegraphics[width=16cm]{figs/rstan_downloads_forecast_zoomed.pdf}}
    \only<3>{\hspace*{-.5cm}\includegraphics[width=11.25cm]{figs/rstan_downloads_components.pdf}}
...
\begin{frame}
  ...
  \only<1>{\includegraphics[width=11cm]{figs/pguess.pdf}}
  \only<2>{\includegraphics[width=11cm]{figs/pguessprior.pdf}}
  \only<3>{\includegraphics[width=11cm]{figs/ppost.pdf}}
...
\begin{frame}
  ...
  \begin{center}
    \only<1>{\includegraphics[width=9cm]{figs/lbinom10a.pdf}\\
      \vspace{-0.6\baselineskip}
{\hspace{-12mm}\scriptsize $p(y=6|n=10,{\color{red}\theta})$:\, 0.00\, 0.00\, 0.01\,\, 0.04\, 0.11\, \textbf{0.21}\, 0.25\, 0.20\, 0.09\, \textbf{0.01}\,\, 0.00}}
    \only<2>{\includegraphics[width=9cm]{figs/lbinom10b.pdf}\\
      \vspace{-0.6\baselineskip}
{\hspace{-14mm}\scriptsize $\,$}}
    \only<3>{\includegraphics[width=9cm]{figs/lbinom10c.pdf}\\
      \vspace{-0.6\baselineskip}
      \only<3>{\hspace{-14mm}\scriptsize $\,$}}
    \only<4-5>{\includegraphics[width=9cm]{figs/lbinom10d.pdf}\\
      \vspace{-0.6\baselineskip}
