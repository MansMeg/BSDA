...
\begin{frame}
  ...
  \item Posterior
    ...
    \end{align*}
    \vskip -2mm
	  \item<4-> $\alpha$ and $\beta$ can be considered to be number of prior observations
    \begin{itemize}
    \item<5-> \uured{Discussion question}: What do $\alpha$ and $\beta$ behave like
...
\begin{frame}
  ...
  E(X) = V(X) = \lambda
  \]
  \item<3-> \uured{Discussion}: What would make this assumption questionable
