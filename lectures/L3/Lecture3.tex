...
\begin{frame}
  ...
  \begin{itemize}
  \item ``Tasks 2b and 2d were unclear'' (on our list now)\pause
...
\begin{itemize}
  ...
  \pause
  \item Submit to the correct assignment - the submission is anonymous
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Marginal posterior $p(\mu \mid y)$}
    ...
    \uncover<4->{p(\mu \mid y) & = \underbrace{t_{n-1}(\mu \mid \bar{y},s^2/n)}_{\text{Student's $t$}}}
    \end{align*}
