...
\frametitle{Monte Carlo vs. deterministic}
...
\frametitle{Example: Kilpisjärvi summer temperature}
  ...
  \begin{minipage}[b][12cm][t]{12cm}
    \only<1->{\includegraphics[width=4cm]{figs/kilpis_phist100_mcse1a.pdf}}
    \only<2->{\includegraphics[width=4cm]{figs/kilpis_phist100_mcse2a.pdf}}
    \only<3->{\includegraphics[width=4cm]{figs/kilpis_phist100_mcse3a.pdf}}\\
    \only<1->{\includegraphics[width=4cm]{figs/kilpis_phist100_mcse1b.pdf}}
    \only<2->{\includegraphics[width=4cm]{figs/kilpis_phist100_mcse2b.pdf}}
    \only<3->{\includegraphics[width=4cm]{figs/kilpis_phist100_mcse3b.pdf}}\\
    \begin{center}
      \vspace{-\baselineskip}
...
\frametitle{Example: Kilpisjärvi summer temperature}
  ...
  \begin{center}
    \only<1>{\includegraphics[width=10cm]{figs/kilpis_ppneg_mcse1a.pdf}}
    \only<2>{\includegraphics[width=10cm]{figs/kilpis_ppneg_mcse1b.pdf}}
    \only<3>{\includegraphics[width=10cm]{figs/kilpis_ppneg_mcse1c.pdf}}
    \only<4>{\includegraphics[width=10cm]{figs/kilpis_ppneg_mcse1000.pdf}}
    \only<5>{\includegraphics[width=10cm]{figs/kilpis_ppneg_mcse4000.pdf}}
  \end{center}
...
\frametitle{Rejection sampling}
  ...
  \begin{center}
    ...
    \only<1>{\includegraphics[width=10cm]{figs/rejection1.pdf}}
    \only<2>{\includegraphics[width=10cm]{figs/rejection2.pdf}}
    \only<3>{\includegraphics[width=10cm]{figs/rejection3.pdf}}
  \end{center}
   ...
   \makebox[12cm][t]{
     ...
     \begin{minipage}[t][12cm][t]{12cm}
       \begin{center}
        ...
        \includegraphics[width=3.4cm]{figs/bioassayis1d.pdf}
      \includegraphics[width=3.4cm]{figs/bioassayis1s.pdf}
      \includegraphics[width=3.4cm]{figs/bioassayis1h.pdf}\\
      \only<2->{
        \makebox[0cm][t]{\hspace{-0.5cm}\rotatebox{90}{\hspace{1cm}Normal}}
      \includegraphics[width=3.4cm]{figs/bioassayis2d.pdf}
      \includegraphics[width=3.4cm]{figs/bioassayis2s.pdf}
      \includegraphics[width=3.4cm]{figs/bioassayis2h.pdf}\\}
    ...
    \only<3>{But the normal approximation is not that good here:\\ Grid sd(LD50) $\approx$ 0.1, Normal sd(LD50) $\approx$ .75!}
      ...
      \includegraphics[width=3.4cm]{figs/bioassayis3d.pdf}
      \includegraphics[width=3.4cm]{figs/bioassayis3s.pdf}
      \includegraphics[width=3.4cm]{figs/bioassayis3h.pdf}\\}
...
\frametitle{Example: Importance sampling in Bioassay}
   ...
   \makebox[12cm][t]{
     ...
     \begin{minipage}[t][6cm][t]{6cm}
       \begin{center}
       Grid\\
       \includegraphics[width=6cm]{figs/bioassayis1s.pdf}
     \end{center}
     \end{minipage}
     \begin{minipage}[t][6cm][t]{6cm}
       \begin{center}
       IR\\
       \includegraphics[width=6cm]{figs/bioassayis3s.pdf}
  \end{center}
  \end{minipage}
}
...
\frametitle{Example: Importance sampling in Bioassay}
       ...
       \begin{center}
       IR\\
       \includegraphics[width=10cm]{figs/bioassayis3s.pdf}
  \end{center}
...
\frametitle{Example: Importance sampling in Bioassay}
       ...
       \begin{center}
       \only<1>{\includegraphics[width=10cm]{figs/bioassayisw1.pdf}}
       \only<2>{\includegraphics[width=10cm]{figs/bioassayisw2.pdf}}
       \only<3>{\includegraphics[width=10cm]{figs/bioassayisw3.pdf}}
  \end{center}
