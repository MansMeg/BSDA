...
\frametitle{Numerical integration}
  ...
  And the Riemann integral:
    ...
    where
    \begin{align*}
    {\displaystyle \Delta x={\frac {b-a}{S}}.}
    \end{align*}
...
\frametitle{Numerical integration}
  ...
  \begin{itemize}
  \item Remember the Riemann sum and the Riemann integral:
     \begin{align*}
     {\displaystyle I_{a}^{b}=\sum _{i=1}^{S}f(x_{s}^{*})\,\Delta x_{s}\,,}
       \end{align*}
     where
        \begin{align*}
