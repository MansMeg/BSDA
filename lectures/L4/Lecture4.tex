...
% TODO: Add a slide on what MC is. I.e. we draw a sample from a density.
% This can be used to approximate any integration
...
% TODO: Define efficient sample size
...
% TODO: Add example of S_eff for different settings of IS
% (1/S)^2 = S 1/S^2
