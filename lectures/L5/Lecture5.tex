...
\frametitle{ Several chains}
      ...
      \begin{center}
      \only<1>{\includegraphics[width=10cm]{figs/10chains2.pdf}}
      \only<2->{\includegraphics[width=10cm]{figs/10chains3.pdf}}\\
...
\frametitle{ $\widehat{R}$: comparison of within and between variances of the chains}
  ...
  \item Compare means and variances of the chains\\
    ...
    \vspace{1\baselineskip}
    \only<1>{\hspace{-0.5cm}\phantom{\includegraphics[width=10.5cm]{figs/10chains_rhat1.pdf}}}
    \only<2>{\hspace{-0.5cm}\includegraphics[width=10.5cm]{figs/10chains_rhat1.pdf}}
    \only<3>{\hspace{-0.5cm}\includegraphics[width=10.5cm]{figs/10chains_rhat2.pdf}}
    \only<4>{\hspace{-0.5cm}\includegraphics[width=10.5cm]{figs/10chains_rhat3.pdf}}
  \end{itemize}
...
\frametitle{ $\widehat{R}$}
  ...
  \item Compare means and variances of the chains\\
    ...
    var\_hat\_plus = total variance estimate\\
    \vspace{1\baselineskip}
    \only<1>{\hspace{-0.5cm}\includegraphics[width=10.5cm]{figs/10chains_rhat1.pdf}}
    \only<2>{\hspace{-0.5cm}\includegraphics[width=10.5cm]{figs/10chains_rhat2.pdf}}
    \only<3>{\hspace{-0.5cm}\includegraphics[width=10.5cm]{figs/10chains_rhat3.pdf}}
  \end{itemize}
...
\frametitle{ Auto correlation}
  ...
  \uncover<2->{\includegraphics[width=7cm]{figs/Metrop1trace.pdf}\\}
  \uncover<3->{\includegraphics[width=7cm]{figs/Metrop1acf.pdf}}
...
\begin{frame}
 ...
 \frametitle{ Effective sample size}
  ...
  \makebox[12cm][t]{
    \hspace{-.7cm}
     \begin{minipage}{12cm}
     \includegraphics[width=6cm]{figs/Metrop1trace.pdf}
     \includegraphics[width=6cm]{figs/Metrop1acf.pdf}\\
     \includegraphics[width=6cm]{figs/Metrop1mcerr.pdf}
     \hspace{0cm}
...
\begin{frame}
 ...
 \frametitle{ Next week: HMC, NUTS, and dynamic HMC}

   Effective sample size $\ESS = S_\eff \approx S/\hat{\tau}$\\
  \makebox[12cm][t]{
    \hspace{-.7cm}
     \begin{minipage}{12cm}
     \includegraphics[width=6cm]{figs/hmc1trace.pdf}
     \includegraphics[width=6cm]{figs/hmc1acf.pdf}\\
     \includegraphics[width=6cm]{figs/hmc1mcerr.pdf}
     \hspace{0cm}
     \begin{minipage}[t][4cm][t]{6cm}
       \vspace{-3.5cm}
       \begin{align*}
...
\begin{frame}
 ...
 \frametitle{ Further diagnostics}
