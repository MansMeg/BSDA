...
\frametitle{Dynamic HMC}
  ...
  \begin{itemize}
  \item Goal: Simplify the tuning of HMC
  \item \uured{dynamic} HMC refers to \uured{dynamic} trajectory length of the leapfrog integrator (i.e. $L$ is chosen on the fly)
  \item The NUTS/dynamic algorithm:
  \begin{enumerate}
    \item Grow a tree of leapfrog steps $L$
    \item Simulate in two directions (to keep reversibility of Markov chain)
