...
\frametitle{Hamiltonian Monte Carlo}
  ...
  \end{itemize}
  \vspace{-0.5\baselineskip}
  \only<1>{\phantom{\includegraphics[width=9cm]{figs/hmcdemo01.pdf}}}
  \only<2>{\includegraphics[width=9cm]{figs/hmcdemo01.pdf}}
  \only<3>{\includegraphics[width=9cm]{figs/hmcdemo02.pdf}}
  \only<4>{\includegraphics[width=9cm]{figs/hmcdemo03.pdf}}
  \only<5>{\includegraphics[width=9cm]{figs/hmcdemo04.pdf}}
  \only<6>{\includegraphics[width=9cm]{figs/hmcdemo05.pdf}}
  \only<7>{\includegraphics[width=9cm]{figs/hmcdemo06.pdf}}
  \only<8>{\includegraphics[width=9cm]{figs/hmcdemo07.pdf}}
  \only<9>{\includegraphics[width=9cm]{figs/hmcdemo08.pdf}}
  \only<10>{\includegraphics[width=9cm]{figs/hmcdemo09.pdf}}
  \only<11>{\includegraphics[width=9cm]{figs/hmcdemo10.pdf}}
  \only<12>{\hspace{-5mm}\includegraphics[width=12cm]{figs/hmc1trace.pdf}}
  \only<13>{\hspace{-5mm}\includegraphics[width=12cm]{figs/hmc1acf.pdf}}
  \only<14>{\hspace{-5mm}\includegraphics[width=12cm]{figs/hmc1mcerr.pdf}}
\end{frame}
