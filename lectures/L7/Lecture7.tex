...
\frametitle{Assignment 6 }
  ...
  \begin{itemize}
  \item Difficulties with stan: R-studio can check stan syntax + take small steps
  \item Repetition - there is a purpose behind this.
  \item $\hat{R}$ as a posterior statistic of interest
  \end{itemize}
\end{frame}
