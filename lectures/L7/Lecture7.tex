...
\frametitle{Hierarchical binomial model: rats}
  ...
  \only<1>{\includegraphics[width=10cm]{figs/rats_pooled.pdf}}
  \only<2>{\includegraphics[width=10cm]{figs/rats_separate.pdf}}
...
\frametitle{Hierarchical binomial model: rats}
  ...
  \only<2>{\includegraphics[width=10cm]{figs/rats_hierdraws.pdf}}
  \only<3>{\includegraphics[width=10cm]{figs/rats_hierprior.pdf}}
...
% Cant find these figures
%    \hspace{0.2cm} Separate \hspace{4.3cm} Hierarchical
%  \begin{minipage}[b]{12cm}
%    {  \hspace{-0.7cm}~\includegraphics[width=6cm]{figs/radon2.pdf}\includegraphics[width=6cm]{figs/radon4.pdf}}
%  \end{minipage}
