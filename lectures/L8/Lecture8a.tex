...
\frametitle{Mini-project comments}
  ...
  \item Remember - look at the instructions. I have failed people with 4.5 pages. Or just 3 pages. \uured{Why do I care about this?} \pause
...
\frametitle{Posterior predictive checking -- example}
  ...
  \item<4-> Connections:
  \begin{itemize}
    \item \uured{Sufficient statistic}: contains all the information about $\theta$
    \item \uured{Ancillary statistic}: contains no information about $\theta$
  \end{itemize}
  \end{itemize}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{figs/ppc_dens1.png}
\caption{Model 1}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{figs/ppc_dens2.png}
\caption{Model 2}
\end{figure}
Kernel density estimate of the observed dataset $y$ (dark curve), with density
estimates for 100 simulated datasets $y^{(\text{rep})}$ drawn from the posterior predictive distribution (thin, lighter lines)
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{figs/ppc_dens3.png}
\caption{Model 3}
\end{figure}
Kernel density estimate of the observed dataset $y$ (dark curve), with density
estimates for 100 simulated datasets $y^{(\text{rep})}$ drawn from the posterior predictive distribution (thin, lighter lines)
