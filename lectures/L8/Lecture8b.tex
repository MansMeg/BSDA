...
\begin{frame}
 ...
 \frametitle{Model assessment, selection and inference after selection}
...
\frametitle{Predicting concrete quality}

%  \begin{center}
%    \includegraphics[width=5cm]{figs/slump1b.eps}
%  \end{center}
...
\frametitle{Predicting cancer recurrence}

  \begin{center}
    \includegraphics[width=11.5cm]{figs/gistrisk.png}
  \end{center}
...
% \frametitle{Model assessment, comparison, selection and averaging}
...
\begin{frame}{}
  ...
  \only<1>{\includegraphics[width=10cm]{figs/fake1.pdf}}
  \only<2>{\includegraphics[width=10cm]{figs/fake2.pdf}}
  \only<3>{\includegraphics[width=10cm]{figs/fake3.pdf}}
  \only<4>{\includegraphics[width=10cm]{figs/fake4.pdf}}
  \only<5>{\includegraphics[width=10cm]{figs/fake4b.pdf}}
  \only<6>{\includegraphics[width=10cm]{figs/fake4.pdf}}
  \only<7>{\includegraphics[width=10cm]{figs/fake4s.pdf}}
  \only<8-9>{\includegraphics[width=10cm]{figs/fake5.pdf}}
  \only<10>{\includegraphics[width=10cm]{figs/fake5n.pdf}}
  \only<11>{\includegraphics[width=10cm]{figs/fake6.pdf}}
  \only<12>{\includegraphics[width=10cm]{figs/fake7.pdf}}
  \\
...
\begin{frame}{}
  ...
  {\includegraphics[width=10cm]{figs/fake7r.pdf}}
  \\
...
\begin{frame}{}
  ...
  {\includegraphics[width=10cm]{figs/fake8.pdf}}
  \\
...
\begin{frame}{}
  ...
  \only<1-2>{\includegraphics[width=10cm]{figs/fake8pd.pdf}}
  \only<3>{\includegraphics[width=10cm]{figs/fake8loopd.pdf}}
  \\
...
\begin{frame}{}
  ...
  \only<1>{\includegraphics[width=10cm]{figs/fake8loopds.pdf}}
  \only<2->{\includegraphics[width=10cm]{figs/fake8loolpds.pdf}}
...
\begin{frame}{}
  ...
  \only<1>{\includegraphics[width=10cm]{figs/fakedfixed.pdf}}
  \only<2->{\includegraphics[width=10cm]{figs/fakedrandom.pdf}}
  \\ \vspace{-0.5\baselineskip}
...
\begin{frame}{}
  ...
  \only<1>{\includegraphics[width=10cm]{figs/lake1data.pdf}}
  \only<2>{\includegraphics[width=10cm]{figs/lake1gp.pdf}}
  \only<3->{\includegraphics[width=10cm]{figs/lake1gpptest.pdf}}
  \\
...
\begin{frame}{}
  ...
  \includegraphics[width=10cm]{figs/lake2data.pdf}
...
\begin{frame}{}
  ...
  \only<1>{\includegraphics[width=10cm]{figs/lake3loo.pdf}}
  \only<2>{\includegraphics[width=10cm]{figs/lake3stepahead.pdf}}
  \only<3>{\includegraphics[width=10cm]{figs/lake3tenstepahead.pdf}}
  \only<4>{\includegraphics[width=10cm]{figs/lake3stepaheadblock.pdf}}
  \\
...
\begin{frame}{}
  ...
  \only<1>{\includegraphics[width=10cm]{figs/rats1data.pdf}}
  \only<2>{\includegraphics[width=10cm]{figs/rats1loo.pdf}}
  \only<3>{\includegraphics[width=10cm]{figs/rats1step.pdf}}
  \only<4>{\includegraphics[width=10cm]{figs/rats1onetime.pdf}}
  \only<5>{\includegraphics[width=10cm]{figs/rats1onerat.pdf}}
  \only<6>{\includegraphics[width=10cm]{figs/rats1init.pdf}}
  \\
...
%\begin{frame}{}
%
%  \only<1>{\includegraphics[width=10cm]{figs/fakedata.pdf}}
%  \only<2>{\includegraphics[width=10cm]{figs/fakedraws.pdf}}
%  \only<3>{\includegraphics[width=10cm]{figs/fakepostpred.pdf}}
%  \only<4>{\includegraphics[width=10cm]{figs/fakepostpred18.pdf}}
%  \only<5-7>{\includegraphics[width=10cm]{figs/fakepsisdraws.pdf}}
%  \only<8-10>{\includegraphics[width=10cm]{figs/fakepsispostpred.pdf}}
%  \\
...
\begin{frame}{}
  ...
  \only<1>{\includegraphics[width=10cm]{figs/lake4data.pdf}}
  \only<2>{\includegraphics[width=10cm]{figs/lake4pred.pdf}}
  \only<3>{\includegraphics[width=10cm]{figs/lake4psisrefits.pdf}}
...
\begin{frame}{}
  ...
  \only<1>{\includegraphics[width=10cm]{figs/lake3kfoldbal1.pdf}}
  \only<2>{\includegraphics[width=10cm]{figs/lake3kfoldbal2.pdf}}
  \only<3>{\includegraphics[width=10cm]{figs/lake3kfoldrand.pdf}}
  \only<4>{\includegraphics[width=10cm]{figs/rats1kfoldrand.pdf}}
  \only<5->{\includegraphics[width=10cm]{figs/rats1oneratb.pdf}}
  \\
