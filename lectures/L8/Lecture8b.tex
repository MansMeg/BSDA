...
%
%  \begin{center}
%    \includegraphics[width=10cm]{figs/gistrisk.png}
%  \end{center}
%\end{frame}
...
% Kopiera mina slides från AISTATS
...
\frametitle{Predictive performance}
  ...
  \begin{itemize}
  \item Model choice is a decision-theoretic problem (see next week)
  \pause
  \item We need to choose the utility/cost function to maximize in our decision
  \pause
