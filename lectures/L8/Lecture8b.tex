...
\[
\text{elpd}_M= \int \log p_M({\color{uured}\tilde{y}_i}|y) p_t({\color{uured}\tilde{y}_i}) d{\color{uured}\tilde{y}_i}\,,
\]
...
% Move summary slide here. Also add the p_true here

% You need to specify the data generating process. this is an assumption

% Time series - extrapolation is more problematic
...
%\begin{frame}{}
%
%  \only<1>{\includegraphics[width=8cm]{fakepsisweights.pdf}}
%  \only<2->{\includegraphics[width=8cm]{fakepsisweights4000.pdf}}
%  \\
%  \vspace{-\baselineskip}
...
%\begin{frame}[fragile]
%
%  \includegraphics[width=8cm]{fakepks.pdf}
%
%\end{frame}

%\begin{frame}[fragile]
%
%  \only<1>{\includegraphics[width=8cm]{fakepks.pdf}}
%  \only<2>{\includegraphics[width=8cm]{fakeneffs.pdf}}
%  \\
%  {\scriptsize
%\begin{lstlisting}
%    Pareto k diagnostic values:
...
%   \only<1-2>{\includegraphics[width=8cm]{milkelpdloo.pdf}}
...
%   {\includegraphics[width=8cm]{milkelpddiff.pdf}}
%   \\
%   {\scriptsize
% \begin{lstlisting}
% Model comparison:
