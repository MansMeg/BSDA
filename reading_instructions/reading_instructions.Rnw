...
\item Video assignment before the hierarchical models assignment:
  \href{https://www.youtube.com/watch?v=dNZQrcAjgXQ}{Hierarchical Modelling in Stan: Predicting the Premier League}
\end{list}
...
\item Complementary video: Matthew Kay's StanCon 2026 lecture
  \href{https://youtu.be/drngQr8eyXg}{Systematic uncertainty visualization design}
  is recommended project material on communicating posterior uncertainty and
...
\item Video assignment before reporting Stan diagnostics:
  \href{https://www.youtube.com/watch?v=0FdMZwIbJ_4}{Have I converged? Convergence checks in Stan.}
\end{list}
...
\item Video assignment before the first Stan assignment:
  \href{https://www.youtube.com/watch?v=4t6niM6sksI}{Getting started with Stan in R}
  (Python users may also watch
