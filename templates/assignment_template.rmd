...
# LLM use and integrity

You may use large language models (LLMs), such as ChatGPT, like you may discuss with fellow students: to learn, ask for explanations, and get feedback. You may not use LLMs to produce the solution you submit. You must be able to explain every part of your submitted work orally.
...
[Write one possible oral exam question for this assignment, together with a short model answer. The question should concern material from this assignment or the associated reading, be suitable for a 2-4 minute oral answer, and test conceptual understanding rather than only calculation or code. The question should not already be included in the oral exam question list and should not be very close to an existing question. The question and model answer are part of the solution you submit. You are not allowed to use LLMs at all for this oral exam question contribution.]

[State clearly whether the course staff may use or adapt your question and answer in a future oral exam: Yes or No.]
...
You are allowed to use any format to produce your report. For example, you can use Jupyter Notebooks, as long as you abide by the instructions in this template. In addition, the report needs to be exported as a PDF, and has to have reasonable aspect ratio (A4) and font size.
