...
[Write one possible oral exam question for this assignment, together with a short model answer. The question should concern material from this assignment or the associated reading, be suitable for a 2-4 minute oral answer, and test conceptual understanding rather than only calculation or code. The question should not already be included in the oral exam question list and should not be very close to an existing question. The question and model answer are part of the solution you submit. You may discuss concepts with LLMs under the course LLM policy, but you may not use LLMs to write the submitted question or answer.]
